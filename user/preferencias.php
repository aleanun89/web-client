...
if(isset($_GET["mod"])) {
   ...
   if($_POST["passmd5"]!=$_POST["pass2md5"]) {
      ...
      if($_POST["passmd5"]=="d41d8cd98f00b204e9800998ecf8427e") {
         ...
         $parametros = Array('username' => $_SESSION["username"], 'token' => $_SESSION["token"], 'id' => $_POST["id"], 'nombre' => $_POST["nombre"], 'apellidos' => $_POST["apellidos"], 'correo' => $_POST["correo"], 'alergias' => $alergias);
      } else {
         // El password se cambia
         $parametros = Array('username' => $_SESSION["username"], 'token' => $_SESSION["token"], 'id' => $_POST["id"], 'password' => $_POST["passmd5"], 'nombre' => $_POST["nombre"], 'apellidos' => $_POST["apellidos"], 'correo' => $_POST["correo"], 'alergias' => $alergias);
      ...
      $estado = $json->{'status'};
      if($estado==1) {
         echo "Preferencias del usuario actualizadas con exito.<br><br>";
      } else {
...
$url = 'https://api.alergant.es/userid/';
...
$userid = $json[1]->{'ID'};
$parametros = Array('username' => $_SESSION["username"], 'token' => $_SESSION["token"], 'id' => $userid);
...
<form id="userform" name="userform" action="<?php echo $web; ?>/user/preferencias.php?mod=1" method="post">
<div class="divform">
 <div class="r">
